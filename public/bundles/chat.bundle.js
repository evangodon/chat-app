...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--0-1!../../node_modules/postcss-loader/lib/index.js!./global-styles.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--0-1!../../node_modules/postcss-loader/lib/index.js!./global-styles.css");
...
var _scrollToBottom = __webpack_require__(67);

var _scrollToBottom2 = _interopRequireDefault(_scrollToBottom);

__webpack_require__(68);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Mustache = __webpack_require__(69);
...
client.on('connect', function () {
    ...
    client.emit('join', params, function (err) {
        if (err) {
            alert(err);
...
client.on('updateUserList', function (users) {
    var ul = $('<ul></ul>');
...
client.on('fillRoomWithMessages', function (messages) {
    ...
    messages.forEach(function (message) {
        ...
        (0, _scrollToBottom2.default)();
    });
});

// Admin messages
client.on('adminMessage', function (message) {
    var template = $('#message-template').html();
    var html = Mustache.render(template, {
        text: message.text,
        createdAt: message.createdAt
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(11)))
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--0-1!../../node_modules/postcss-loader/lib/index.js!./chat-styles.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--0-1!../../node_modules/postcss-loader/lib/index.js!./chat-styles.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "*{box-sizing:border-box;margin:0;padding:0;font-family:Roboto,Helvetica Neue Light,Helvetica Neue,Helvetica,Arial,Lucida Grande,sans-serif;font-weight:300;font-size:.95rem}.chat,.chat__sidebar{display:-webkit-box;display:-ms-flexbox;display:flex}.chat__sidebar{overflow-y:scroll;width:260px;height:100vh;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;background:#2e3192;background:-webkit-gradient(left top,right bottom,color-stop(0,#2e3192),color-stop(52%,#249ccb),color-stop(90%,#1deaf4),color-stop(100%,#1bffff));background:linear-gradient(135deg,#2e3192,#249ccb 52%,#1deaf4 90%,#1bffff);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=\"#2e3192\",endColorstr=\"#1bffff\",GradientType=1)}.chat__messages,.chat__sidebar ul{list-style-type:none}.chat__main{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;height:100vh;width:100%}.chat__sidebar h3{color:#e6eaee;margin:10px 20px;text-align:left}.chat__sidebar li{border:1px solid #e1e1e1;border-radius:5px;margin:10px}.chat__messages{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;overflow-y:scroll;-webkit-overflow-scrolling:touch;padding:10px}.chat__footer{-ms-flex-negative:0;flex-shrink:0}.chat__footer,.chat__footer form{display:-webkit-box;display:-ms-flexbox;display:flex}.chat__footer form{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1}.chat__footer form *{margin-right:10px}.chat__footer input{border:none;padding:10px;-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1}.chat__footer,.chat__sidebar li{background:#e6eaee;padding:10px}.message{padding:10px}.message__title{display:-webkit-box;display:-ms-flexbox;display:flex;margin-bottom:5px}.message__title h4{font-weight:600;margin-right:10px}span.time-stamp{color:#999;font-size:.75rem;margin:5px}.leave-room-btn,.leave-room-btn:hover{margin:auto 40px 15px;padding:5px 10px}@media (max-width:600px){*{font-size:1rem}.chat__sidebar{display:none}.chat__footer{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.chat__footer form{margin-bottom:10px}.chat__footer button{margin-right:0}}", ""]);
